  ...
  return (
    <>
      <Heading as="h4" scale="md" mb="8px">
        {t('1MM Swap Collectibles')}
      </Heading>
      <Text as="p">
        {t('1MM Swap Collectibles are special ERC-721 NFTs that can be used on the 1MM Swap platform.')}
      </Text>
      <Text as="p">
        {t('NFTs in this user’s wallet that aren’t approved 1MM Swap Collectibles won’t be shown here.')}
      </Text>
      ...
      <Flex alignItems="center" justifyContent="flex-end">
        <Link to="/collectibles">{t('See all approved 1MM Swap Collectibles')}</Link>
        <ChevronRightIcon />
      </Flex>
    </>
  )
