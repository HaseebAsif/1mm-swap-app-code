...
import { BUSD, DAI, USDT, BTCB, CAKE, WBNB, UST, ETH } from './tokens'

export const ROUTER_ADDRESS = '0x764850D636E708573Fad692965304dA016f2Ae00'
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  [ChainId.MAINNET]: [WETH[ChainId.MAINNET], CAKE[ChainId.MAINNET], BUSD[ChainId.MAINNET], USDT, BTCB, UST, ETH],
